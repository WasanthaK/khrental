...
VALUES 
    ...
    ('redirect_url', 'https://khrentals.azurewebsites.com/auth/evia-callback', false, 'Redirect URL for OAuth authentication flow'),
    ('webhook_url', 'https://khrentals.azurewebsites.com/api/webhooks/evia', false, 'Webhook URL to receive Evia Sign events'),
